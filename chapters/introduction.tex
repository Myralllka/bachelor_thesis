...
Nowadays, even collaborative transportation systems are not something fictional - swarms have become more popular, and that allows their usage for the transportation of really massive objects \cite{Bacelar2020} that one drone can not lift. 
...
UAVs are expensive and quite heavy, so accidents can be expensive and even cost somebody's life. 
...
The best, for now, can be the Skydio system \footnotetext{\href{https://www.skydio.com/skydio-autonomy}{https://www.skydio.com/skydio-autonomy - Skydio autonomy}}, but their approach is for a forward-moving drone.
...
Structure from Motion (SfM) is another possible algorithm that can implement a system for avoiding obstacles. 
