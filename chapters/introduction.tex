...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.65\textwidth}
      ...
      \label{fig:pc_output}
    \end{subfigure}
    \caption{Ilustration of Structure from Motion}
    \label{fig:pc_recons}
\end{figure}
...
The flight envieronment is assumed to be well-lit and to contain objects with well-distinguishable visual features tat can be observed by the cameras.
