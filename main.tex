...
The 21st century is a time of innovation and exploration in the applied science field as physics, medicine, biology and programming, as well as at their intersections and fusions.
One of the most popular topics nowadays is an autonomous flying vehicle.
They became smaller, cheaper and more available for people.
Along with their popularity, the demand and need for research in this field are growing.

This thesis concentrate on the problem of visual multi-camera obstacle avoidance for micro aerial vehicles.
...
It was designed to run onboard the drone with size and lifting limitations.
The performance of the proposed solution was measured in laboratory experiments.
