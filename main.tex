...
$\vec{t}$ & Column vector that reresents a point/line/vector & \\
$\pmb{\mathsf{A}}$ & Matrix & \\
$\pmb{\mathsf{A}}^\top$ & Transpose of a matrix & \\
$\pmb{\mathsf{R}}$ & Rotation matrix 3x3, $det(\pmb{\mathsf{R}}) = 1, \pmb{\mathsf{R}}^\top = \pmb{\mathsf{R}}^{-1}$ & \\
$\pmb{\mathsf{I}}$ & Identity matrix & \\
$f$ & focal length & px \\
